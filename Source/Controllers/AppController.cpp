...
void AppController::createTracks(BusToSettingsMap &busToSettingsMap, BusToTracksMap &busToTracksMap)
{
    mTrackGenerator->renderAudio(busToSettingsMap, busToTracksMap);
}
